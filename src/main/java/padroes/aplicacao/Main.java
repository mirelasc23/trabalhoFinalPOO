package padroes.aplicacao;

import padroes.entidades.*;
...
public class Main {
    ...
    static int comando, i, resp, qtde;

    public static void main(String[] args) throws ParseException {
        Date validade, agendamento, hora;
        ...
        //PRODUTOS
        brinquedo = new Brinquedo("Bola de Borracha", 30.0, 4);
        ...
        listaEstoque.add(estoqueBrinquedo);
        Estoque estoqueRacao = new Estoque(racao);
        listaEstoque.add(estoqueRacao);
        Estoque estoqueMedicamento = new Estoque(medicamento);
        listaEstoque.add(estoqueMedicamento);
        ...
        estoqueMedicamento.adicionarProduto(1);
        estoqueBrinquedo.adicionarProduto(2);
        estoqueRacao.adicionarProduto(4);
        ...
        do {
            ...
            switch (comando) {
                ...
                case 10:
                    ...
                    listaEstoque.get((resp - 1)).adicionarProduto(qtde);

                    break;

                case 11:
                    System.out.println("Escolha o produto que será removido:");
                    listarProdutos();
                    
                    System.out.println("Informe a quantidade: ");
                    qtde = ler.nextInt();

                    listaEstoque.get((resp - 1)).removerProduto(qtde);
                    break;

                case 12:
                    System.out.println(listaVenda.size());
                    
                    Venda v4 = new Venda((listaVenda.size()+1));
                    
                    System.out.println("Adicinar: ");
                    System.out.println("0 - Outra Opçao"
                            + "\n1 - Produto;"
                            + "\n2 - Serviço"
                            + "\n3 - Agendamento");
                    resp = ler.nextInt();
                    ...
                    switch (resp){
                        ...
                        case 1:
                            ...
                            v4.adicionarProduto(listaProduto.get((resp-1)), qtde);
                        ...
                        case 2:
                            ...
                            v4.adicionarServico(listaServico.get((resp-1)), qtde);
                            
                            break;
                            
                        case 3:
                            System.out.println("Selecione o serviço do agendamento:");
                            listarServicos();
                            
                            System.out.println("Informe a data: [dd/mm/aaaa]");
                            agendamento = sdf.parse(ler.next());
                            
                            System.out.println("Informe o horário: [hh:mm]");
                            hora = sdh.parse(ler.next());
                            
                            Agendamento a4 = new Agendamento(listaServico.get((resp-1)), agendamento, hora);
    ...
    public static int listarProdutos(){
        ...
        for (Produto produto : listaProduto) {
            i++;
            System.out.println(i + " - " + listaProduto.get((i - 1)));
        }
    ...
    public static int listarServicos(){
        i = 0;
        for (Servico servico : listaServico) {
            i++;
            System.out.println(i + " - " + listaServico.get((i - 1)));
        }
